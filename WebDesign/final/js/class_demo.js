function change_iframe_display(val) {
    ...
    switch (val) {
        ...
        case 12:
            ...
            break;
        case 111:
            document.getElementById("inner_html").innerHTML = '<iframe src="./w11/index.html"></iframe>';
            break;
        case 112:
            document.getElementById("inner_html").innerHTML = '<iframe src="./w12/index.html"></iframe>';
            break;
        case 113:
            document.getElementById("inner_html").innerHTML = '<iframe src="./w13/dist/index.html"></iframe>';
            break;
        case 114:
            document.getElementById("inner_html").innerHTML = '<iframe src="./w14/dist/index.html"></iframe>';
            break;
        case 115:
            document.getElementById("inner_html").innerHTML = '<iframe src="./w15/dist/index.html"></iframe>';
            break;
        case 116:
            document.getElementById("inner_html").innerHTML = '<iframe src="./w16/index.html"></iframe>';
            break;
    }
}
